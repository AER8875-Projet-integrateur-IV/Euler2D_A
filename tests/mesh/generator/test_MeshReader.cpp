...
TEST(MeshReaderSU2NewFormatTEST, ReadFile) {
	const std::string path = "../../../../tests/mesh/generator/square.su2";
	...
	ASSERT_EQ(mesh.m_nDime, 2);
	ASSERT_EQ(mesh.m_nNode, 9);
	ASSERT_EQ(mesh.m_nElement, 8);
	...
	const double coor_exp[] = {10.1, 0.0,
	                           ...
	                           0.5, 1.0,
	                           1.0, 1.0};
	std::vector<double> coor_v(mesh.m_coor, mesh.m_coor + mesh.m_nNode * mesh.m_nDime);
	...
	const int element2Node_exp[] = {0, 1, 3,
	                                ...
	                                4, 5, 7,
	                                5, 8, 7};
	std::vector<int> element2Node_v(mesh.m_element2Node, mesh.m_element2Node + mesh.m_nElement * 3);
	...
	const int element2NodeStart_exp[] = {0,
	                                     ...
	                                     21,
										 24};
	std::vector<int> element2NodeStart_v(mesh.m_element2NodeStart, mesh.m_element2NodeStart + mesh.m_nElement+1);
